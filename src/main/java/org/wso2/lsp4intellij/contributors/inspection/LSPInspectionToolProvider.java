...
/**
 * LSP Inspection tool provider which must be registred by the library consumer under the extension
 * point {@link InspectionToolProvider#EXTENSION_POINT_NAME}
 *
 * @author gayanper
 */
