...
public enum ConfigurableTypes {
    ARTIFACT(ArtifactLanguageServerDefinition.getInstance().presentableTyp), EXE(
            ExeLanguageServerDefinition.getInstance().presentableTyp), RAWCOMMAND(
            RawCommandServerDefinition.getInstance().presentableTyp);
